...
public class UIManager
{
    ...
    private InstructorsHandler instructorHandler;
    private InstructorManager instructorManager;

    public UIManager()
    {
        courseManager = new CourseManager();
        coursesHandler = new CoursesHandler(courseManager);
        studentManager = new StudentManager();
        studentsHandler = new StudentsHandler(studentManager);
        instructorManager = new InstructorManager();
        instructorHandler = new InstructorsHandler(instructorManager);
    }
        ...
        public void HandleMainMenuChoice(string choice)
        {
            switch (choice)
            {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    Console.WriteLine("Thank you for using the LMS. Goodbye!");
                    Environment.Exit(0);
                    break;
                default:
        ...
        public void HandleCourseMenuChoice(string choice)
        {
            ...
            {
                case "1":
                    coursesHandler.HandleCoursMenuOperations(1);
                    break;
                case "2":
                    coursesHandler.HandleCoursMenuOperations(2);
                    break;
                case "3":
                    coursesHandler.HandleCoursMenuOperations(3);
                    break;
                case "4":
                    DisplayMainMenu();
                    break;
        ...
        public void HandleStudentMenuChoice(string choice)
        {
            ...
            {
                case "1":
                    studentsHandler.HandleStudentMenuOperations(1);
                    break;
                case "2":
                    studentsHandler.HandleStudentMenuOperations(2);
                    break;
                case "3":
                    studentsHandler.HandleStudentMenuOperations(3);
                    break;
        ...
        public void HandleInstructorMenuChoice(string choice)
        {
            ...
            {
                case "1":
                    instructorHandler.HandleInstructorMenuOperations(1);
                    break;
                case "2":
                    instructorHandler.HandleInstructorMenuOperations(2);
                    break;
                case "3":
                    instructorHandler.HandleInstructorMenuOperations(3);
                    break;
                case "4":
                    DisplayMainMenu();
                    break;
